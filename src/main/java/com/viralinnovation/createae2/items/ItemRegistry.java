...
import com.viralinnovation.createae2.blocks.CreateElectricalGeneratorBlock;
...
public class ItemRegistry {
	...
	// public static final Item CreateElectricalGenerator = new BlockItem(CreateElectricalGeneratorBlock, new FabricItemSettings());
	...
	public static void onInitialize() {
		...
		// Registry.register(Registry.ITEM, CreateAE2.ID + ":electrical_generator", CreateElectricalGenerator);
	}
}
